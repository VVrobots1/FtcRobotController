...
@TeleOp(name="Dob_2Driver", group="Linear Opmode")
public class Dob_2Driver extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad2.left_bumper==true) if(bratpos<0.6) bratpos=bratpos+0.05;
            if(gamepad2.right_bumper==true) if(bratpos>0)bratpos=bratpos-0.05;
                ServoArm.setPosition(bratpos);
